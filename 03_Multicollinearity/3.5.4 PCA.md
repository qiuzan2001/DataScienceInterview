...
| **4. Choose number $k$**                                                                                       | (a) Cumulative explained variance ratio (EVR) ≥ 80–95 %;<br>(b) Scree plot “elbow”;<br>(c) Kaiser criterion (eigenvalue > 1 on the correlation matrix);<br>(d) Cross-validation. 四种判据的细节见表格下方说明。 |
...
How useful is PCA in practice? The next section critically examines **why PCA, despite its theoretical elegance, is often less useful in real-world business or applied feature-engineering settings**, where features must stay explainable to stakeholders and regulators.
